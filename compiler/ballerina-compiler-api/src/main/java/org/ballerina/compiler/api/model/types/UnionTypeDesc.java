...
/**
 * Represents the union-type-descriptor.
 * 
 * @since 1.3.0
 */
public class UnionTypeDesc extends BTypeDescriptor {
    private List<BType> memberTypes;
    
    public UnionTypeDesc(List<BType> memberTypes) {
    ...
    public String getSignature() {
        ...
        for (BType typeParameter : this.memberTypes) {
