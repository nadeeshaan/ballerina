 ...
 * @since 1.3.0
 */
public class ArrayTypeDesc extends BTypeDescriptor {
    private BTypeDescriptor memberTypeDesc;

    public ArrayTypeDesc(BTypeDescriptor memberTypeDesc) {
        super(TypeKind.ARRAY);
        this.memberTypeDesc = memberTypeDesc;
    }

    public BTypeDescriptor getMemberTypeDesc() {
        return this.memberTypeDesc;
    }

    @Override
    public String getSignature() {
        return this.memberTypeDesc.getSignature() + this.typeKind.typeName();
    }
}
